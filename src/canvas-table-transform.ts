...
const buildTransform = (
  ctx: VkCanvasContext,
  options: VkCanvasTableTransformOptions | undefined,
...
export function createCanvasTableTransform(
  ctxOrOptions?: VkCanvasContext | VkCanvasTableTransformOptions,
  maybeOptions?: VkCanvasTableTransformOptions,
): VkMarkdownBlockTransform {
  let ctx: VkCanvasContext;
  let options: VkCanvasTableTransformOptions | undefined;

  if (ctxOrOptions != null && "measureText" in ctxOrOptions) {
    ctx = ctxOrOptions;
    options = maybeOptions;
  } else {
    options = ctxOrOptions as VkCanvasTableTransformOptions | undefined;
